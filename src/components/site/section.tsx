...
export function Section({ title, lede, children }: { title: string; lede?: string; children: ReactNode }) {
    return (
        <section className="content-section flex flex-col gap-10 border-t border-secondary pt-12 pb-20">
            <header className="grid gap-3 md:grid-cols-[1fr_1fr] md:items-end md:gap-12">
                <h2 className="content-section-heading font-display text-4xl font-medium tracking-tight text-primary md:text-5xl">{title}</h2>
