...
Source of truth for every yoga-side claim on the site. Confirmed on 2026-09-24.
Edit this file first when a fact changes, then the matching field in
`content/yoga.ts`.

## Practice

Practicing yoga for 3 years, as of 2026-09-24.

Styles: Hatha yoga and Vinyasa yoga.

## Training

- YTT 100-hour, completed, at Vidyarasa (https://vidyarasa.id/).
- YTT 200-hour, in progress.

## Sequence

Practices Surya Namaskar A: Mountain (Tadasana), Upward salute (Urdhva
Hastasana), Forward fold (Uttanasana), Half lift (Ardha Uttanasana),
